...
public class WebController {
	...
	public ResponseEntity<?> getEquiposByCategoria(@RequestParam String categoria) {
		...
		if (equipos.isEmpty()) {
			return new ResponseEntity<>(
				Response.errorResponse(Response.NOT_FOUND, "No se encontraron equipos con la categoría: " + categoria),
	...
	public ResponseEntity<?> getJugadoresByPosicion(@RequestParam String posicion) {
		...
		if (jugadores.isEmpty()) {
			return new ResponseEntity<>(
				Response.errorResponse(Response.NOT_FOUND, "No se encontraron jugadores con la posición: " + posicion),
				HttpStatus.NOT_FOUND
			);
		}
	...
	public ResponseEntity<?> getPartidosByResultado(@RequestParam Resultado resultado) {
		...
		if (partidos.isEmpty()) {
			return new ResponseEntity<>(
				Response.errorResponse(Response.NOT_FOUND, "No se encontraron partidos con el resultado: " + resultado),
				HttpStatus.NOT_FOUND
			);
		}
